        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RelatedClientId = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_Products_RelatedProductId",
                        column: x => x.RelatedProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Orders_Users_RelatedClientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_RelatedClientId",
                table: "Orders",
                column: "RelatedClientId");

            migrationBuilder.CreateIndex(
                name: "IX_Orders_RelatedProductId",
                table: "Orders",
